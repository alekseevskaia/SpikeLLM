...
from transformers.models.qwen3.modeling_qwen3 import apply_rotary_pos_emb, Qwen3RMSNorm, repeat_kv
...
class QuantQwenAttention(nn.Module):
    ...
    def __init__(self, org_module: nn.Module, config: Qwen3Config, args=None):
        super().__init__()
        self.config = config
    ...
    def forward(
        ...
        **kwargs,
        ...
        kv_seq_len = key_states.shape[-2] #new
